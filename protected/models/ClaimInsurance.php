...
/**
 * This is the model class for table "ClaimInsurance".
 *
 * The followings are the available columns in table 'ClaimInsurance':
 * @property integer $Id
 * @property string $Ext
 ...
 */
class ClaimInsurance extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('Ext, Line, Hreg, HN, SessNo, BegHd, HdMode, ClaimAcc, Payers, DlzNew, EpoTn, Epounit, Hct, Paychk, Amount, HDCharge, Payrate, BF, CheckCode', 'length', 'max'=>100),
			array('Flag', 'length', 'max'=>1),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('Id, Ext, Line, Hreg, HN, SessNo, BegHd, HdMode, ClaimAcc, Payers, DlzNew, EpoTn, Epounit, Hct, Paychk, Amount, HDCharge, Payrate, BF, CheckCode, Flag, D_update', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return ClaimInsurance the static model class
	 */
