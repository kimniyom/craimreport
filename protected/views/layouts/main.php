                ...
                <ul class="app-bar-menu">
                    ...
                    <li>
                        ...
                        <ul class="d-menu" data-role="dropdown">
                            <li><a href="<?php echo Yii::app()->createUrl('report/outpatient'); ?>">
                                    <span class="icon mif-user-md"></span> ผู้ป่วยนอกรักษาต่อเนื่องทั่วไป</a></li>
                            <li><a href="<?php echo Yii::app()->createUrl('report/kidneypatient'); ?>">
                                    <span class="icon mif-heartbeat"></span>ผู้ป่วยโรคไต</a></li>
                            <li><a href="<?php echo Yii::app()->createUrl('report/health_insurance'); ?>">
                                    <span class="icon mif-medkit"></span>ผู้ป่วยตามหลักประกันสุขภาพ</a></li>
                            <li><a href="<?php echo Yii::app()->createUrl('report/claim_insurance'); ?>">
                                    <span class="icon mif-mastercard"></span>ผู้ป่วยตามสิทธิประกันสังคม</a></li>
                            <li class="divider"></li>
                            <!--
                    ...
                    <?php if (Yii::app()->session['status'] == 'A') { ?>
                        <li>
                            <a href="" class="dropdown-toggle">ตั้งค่า</a>
                            <ul class="d-menu" data-role="dropdown">
                                <li><a href="<?php echo Yii::app()->createUrl('user/getuser'); ?>">
                                        <span class="icon mif-users"></span>ผู้ใช้งาน</a></li>
                            </ul>
                        </li>
                    <?php } ?>
                </ul>
