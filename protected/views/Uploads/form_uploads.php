...
<script type="text/javascript">
    ...
    $(function () {
        $('#file_upload').uploadify({
            ...
            'uploader': "<?php echo Yii::app()->createUrl('uploads/import_csv') ?>",
            'fileSizeLimit': '100MB',
            'fileTypeExts': '*.csv;',
            'multi': false,
            'width': '250',
            ...
            'onUploadSuccess': function (file, data, response) {
                //alert(file.name);
                $("#work").html('<center><div data-role="preloader" data-type="ring"></div>กำลังนำเข้าข้อมูล ...</center>');
                var url = "<?php echo Yii::app()->createUrl('uploads/import') ?>";
